...
import type { ToolCategory, ToolResult } from "../schemas/agent.js";
import {
  queryAiopsSummary,
  queryCostAnomalies,
...
export const toolDefinitions: ToolDefinition[] = [
  {
    ...
    keywords: ["alert", "alarm", "incident", "告警", "报警"],
    handler: queryAlerts,
  },
  {
    manifest: {
    ...
    keywords: ["cost", "finops", "spend", "bill", "费用", "成本", "账单"],
    handler: queryServiceCost,
  },
  {
    manifest: {
    ...
    keywords: ["eks", "cluster", "pod", "node", "集群", "节点"],
    handler: queryClusterStatus,
  },
  {
    manifest: {
    ...
    keywords: ["resource", "inventory", "ec2", "rds", "s3", "资源"],
    handler: queryResourceInventory,
  },
  {
    manifest: {
      name: "query_logs",
    ...
    keywords: ["log", "error", "trace", "日志", "错误"],
    handler: queryLogs,
  },
  {
    manifest: {
    ...
    keywords: ["diagnose", "incident", "root cause", "rca", "故障", "诊断", "根因"],
    handler: queryIncidentDiagnosis,
  },
  {
    manifest: {
    ...
    keywords: ["anomaly", "cost spike", "overspend", "异常", "费用异常"],
    handler: queryCostAnomalies,
  },
  {
    manifest: {
    ...
    keywords: ["runbook", "triage", "next step", "预案", "下一步"],
    handler: queryRunbookRecommendations,
  },
  {
    manifest: {
    ...
    keywords: ["aiops", "overview", "summary", "all signals", "全套", "总结", "总览"],
    handler: queryAiopsSummary,
  },
  {
    manifest: {
    ...
    keywords: ["服务", "负责人", "owner", "namespace", "dashboard", "依赖", "catalog", "cmdb"],
    handler: queryServiceContext,
  },
];
